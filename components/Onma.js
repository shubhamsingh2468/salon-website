        ...
        <header className="relative pb-24 bg-sky-800 sm:pb-32">
          <div className="absolute inset-0">
            <img
              ...
              src="https://images.unsplash.com/photo-1595944024804-733665a112db?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=870&q=80"
              alt=""
            />
            <div
          ...
          <div className="relative mt-24 max-w-md mx-auto px-4 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">BOOK APPOINTMENT</h1>
            <p className="mt-6 text-xl text-cyan-100 max-w-3xl">
            Visit our appointment pages to book appointment and learn about our products.
