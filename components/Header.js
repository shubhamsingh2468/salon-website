      ...
      <div className="bg-white">
        <header className="relative pb-24 bg-sky-800 sm:pb-32">
          ...
          <div className="relative mt-24 max-w-md mx-auto px-4 sm:max-w-3xl sm:mt-32 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <p className="mt-6 text-xl justify-center text-cyan-100 max-w-3xl">
            At Mahek Salon we offer exceptional hair coloring, graduated cutting, keratin treatment, perm for women, perm for men, balayage, hair contouring, 
color correction service, 
hot scissors service and the top styling in Toronto, and believe the top hair styling and top coloring in Toronto does not need to cost an arm and a leg. 
The Figaro Salon experience is affordable Luxury Hair service.
